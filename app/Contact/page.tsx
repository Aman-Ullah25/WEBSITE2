     ...
     <section className="container mx-auto py-12 px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <img src="../Pictures/loc.png" alt="" height={50} width={50}/>
            ...
            <div className="flex items-center gap-4">
              <img src="../Pictures/phone.png" alt="" height={50} width={50}/>
              <span className="text-blue-500 text-xl"></span>
              <p className="text-gray-700">
            ...
            <div className="flex items-center gap-4">
            <img src="../Pictures/home.png" alt="" height={50} width={50}/>
              <span className="text-blue-500 text-xl"></span>
              <p className="text-gray-700">
          ...
          <div className="bg-white p-8 rounded shadow-md border border-blue-500 " >
            <form>
              <div className="mb-4">
